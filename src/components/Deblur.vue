<template>
    ...
    <a-row>
        <a-card hoverable style="width: 240px; margin-left: 26%" id="blur_rgb">
            <template #cover>
                <img alt="fusion result" :src=rgb ref="image" />
            </template>
            <a-card-meta title="Blur RGB Image"></a-card-meta>
        </a-card>
        <a-card hoverable style="width: 240px; margin-left: 8%" id="slope">
            <template #cover>
                <img width="200px" alt="fusion result" :src=slope ref="image" />
            </template>
            <a-card-meta title="Slope Map"></a-card-meta>
        </a-card>
        <a-card hoverable style="width: 240px" id="offset">
            <template #cover>
    ...
    <a-row>
        <a-card hoverable style="width: 240px; margin-top: 5%" id="sharp_nir">
            <template #cover>
                <img alt="fusion result" :src=nir ref="image" />
            </template>
            <a-card-meta title="Sharp NIR Image"></a-card-meta>
        </a-card>
        <a-card hoverable style="width: 240px; margin-top: 5%; margin-left: 8%" id="blurred_nir">
            <template #cover>
                <img alt="fusion result" :src=blurred_nir ref="image" />
            </template>
            <a-card-meta title="Blurred NIR Image"></a-card-meta>
        </a-card>
        <a-card hoverable style="width: 240px; margin-top: 5%; margin-left: 26%" id="enhancement">
            <template #cover>
